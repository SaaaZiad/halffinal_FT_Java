...
public class AccountController {
  ...
  //Создание страницы кабинета пользователя
  @GetMapping
  ...
  //Создание страницы пополнения баланса пользователя
  ...
  //Обработка страницы на наличие ошибок при вводе данных для пополнения
